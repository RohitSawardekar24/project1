  ...
  if(this.network.noConnection()){
      this.network.showNetworkAlert()
          ...
          this.storage.get('Hash').then((hash) => {
            ...
            this.http
                .post('http://forehotels.com:3000/api/hotel_auth', body, options)
                .subscribe(
                    data => {
                      ...
                      let options = new RequestOptions({ headers: headers });
                      this.http
                          .put('http://forehotels.com:3000/api/device_id', onesignalbody, options)
                          .subscribe(
                              data => {
  ...
  updateCurrentDate(){  
    ...
    this.storage.get('id').then((id) => {
      this.storage.get('Hash').then((key)=>{       
          ...
          let options = new RequestOptions({ headers: headers });
          this.http.post("http://forehotels.com:3000/api/pl",body,options)
            .subscribe(data =>{
